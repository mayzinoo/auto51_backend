...
class Main_model extends CI_Model {
    ...
    function getvehiclespkg($vid){
        ...
        $data = $this->db->query("SELECT car_package.*,car_package.duration as pkgduration,duration.duration_id as duraid,duration.duration as duration_name FROM car_package LEFT JOIN duration ON duration.duration_id=car_package.duration WHERE car_package.vehicle_id=$vid");

        $pkgdata = $this->db->query("SELECT car_package.*,car_package.duration as pkgduration,duration.duration_id as duraid,duration.duration as duration_name FROM car_package LEFT JOIN duration ON duration.duration_id=car_package.duration WHERE car_package.vehicle_id=$vid")->row();
        if($pkgdata->pkgduration!=""){  
       		$res= $data->result();   	
