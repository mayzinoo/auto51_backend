...
<style>
        ...
        .color--dark-gray {
              background-color: #1f925c !important;
            }
        .text-color--white {
              color: #eff7f6 !important;
            }
        .color--light-blue {
          background-color: #91d3b7 !important;
        }
        .text-color--smoke {
              color: #ccc !important;
            }
                ...
                <div class="mdl-card__supporting-text color--dark-gray">
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="mdl-card__title-text text-color--smooth-gray cmytitle">AUTO 51 ADMIN DASHBOARD</span>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="login-name text-color--white">Sign in</span>
                            <span class="login-secondary-text text-color--smoke">Enter fields to sign in to Auto 51</span>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
