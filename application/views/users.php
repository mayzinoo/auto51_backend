                                ...
                                <tr>
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric">
                                        ...
                                        <?php }else if($row->status=='3'){ ?>
                                                <span style="color:#f03f3f"><b>Reject</b></span>
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric">
                                        ...
                                        <?php if($row->status!="3" && $row->status!='2' && $row->role=="dealer"){ ?>
                                            <a onclick="return confirm('Are you sure to reject?')" href="<?php echo base_url() .'dashboard/reject_users/'.$row->id;?>" type="button" class="delete-asset btn btn-danger btn-xs color-white">
                                            Reject
                                        <?php } ?>
