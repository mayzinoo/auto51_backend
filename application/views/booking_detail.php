                        ...
                        <div class="col-md-6 box-content">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url() .'upload/usersinfo/'.$bookingdata->driving_license_front;?>" download>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url() .'upload/usersinfo/'.$bookingdata->driving_license_back;?>" download>
                            ...
                            <div class="row md_topmargin">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url() .'upload/usersinfo/'.$bookingdata->national_id_front;?>" download>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url() .'upload/usersinfo/'.$bookingdata->national_id_back;?>" download>
