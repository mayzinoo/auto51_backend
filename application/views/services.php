...
<div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--4-col-phone">
        <div class="mdl-card mdl-shadow--2dp">
            <div class="mdl-card__title">
                <h1 class="mdl-card__title-text">Included in every car</h1>
            ...
            <div class="mdl-card__supporting-text no-padding">
                <table class="mdl-data-table mdl-js-data-table bordered-table">
                    ...
                    <tr>
                        ...
                        <th width="300" class="mdl-data-table__cell--non-numeric">Name</th>
                            ...
                            ?> 
                                <tr>
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric">
                                        ...
                                        <a onclick="return confirm('Are you sure to delete?')" href="<?php echo base_url() .'dashboard/delete_services/'.$row->id;?>" type="button" class="delete-asset btn btn-danger btn-xs color-white">
      ...
      <div class="modal-content">
         <form method="post">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Add Included in every car</h4>
                </div>
...
<div class="modal fade" id="modal-edit-service" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content">
         <form method="post" action="<?php echo site_url('Dashboard/update_services') ?>">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Edit Included in every car</h4>
                </div>
                <div class="modal-body">
